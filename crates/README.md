...
| **Hardware & verify** | [`spanda-hardware`](spanda-hardware/README.md), [`spanda-certify`](spanda-certify/README.md), `spanda-capability`, [`spanda-readiness`](spanda-readiness/) | `spanda verify`, certification proofs, capability/traceability/health analysis, **operational readiness** |

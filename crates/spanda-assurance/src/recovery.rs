...
pub use spanda_runtime::recovery_primitives::{
...
pub use spanda_runtime::recovery_types::*;

/// Map operational mode to assurance `ModeKind`.
pub fn operational_mode_to_mode_kind(mode: OperationalMode) -> ModeKind {
    match mode {
        OperationalMode::NormalMode => ModeKind::Normal,
        OperationalMode::DegradedMode => ModeKind::Degraded,
        OperationalMode::SafeMode => ModeKind::Safe,
        OperationalMode::EmergencyMode => ModeKind::Emergency,
        OperationalMode::RecoveryMode => ModeKind::Recovery,
    }
}

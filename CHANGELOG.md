...
- **Phase 9 compile pipeline:** `spanda-parser` and `spanda-driver` extracted; `compile`/`check` delegate through `spanda-driver`; `CoreTypeCheckHost` lives in `spanda-runtime-host`.

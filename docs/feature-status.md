...
| **Unified Entity Model** | **Experimental** | `EntityRegistry` projects fleet, devices, humans, providers, packages into entity graph; Control Center Entities tab — [entity-model.md](./entity-model.md) |

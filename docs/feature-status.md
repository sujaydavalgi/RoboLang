...
| **Smart Spaces & Ambient Intelligence** | Official Solution Blueprint #15 — **experimental scaffold** — home-to-city orchestration above Matter/BMS/HA; six example apps, nine optional packages, readiness/assurance/security guides — CI `scripts/smart_spaces_smoke.sh` — stable promotion gate **shipped** — [stable-hardening-smart-spaces.md](./stable-hardening-smart-spaces.md) — [solutions/smart-spaces.md](./solutions/smart-spaces.md) |
